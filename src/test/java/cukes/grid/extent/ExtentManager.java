...
import cukes.grid.stepDefinations.BaseStepsTest;
...
public class ExtentManager {
   ...
   public static String screenshotPath;
	...
	public static void captureScreenshot() {
		i = i + 1;
		File scrFile = ((TakesScreenshot) BaseStepsTest.getDriver()).getScreenshotAs(OutputType.FILE);
